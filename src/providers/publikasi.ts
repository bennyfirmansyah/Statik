...
export class Publikasi {
  ...
  private apiUrl = 'https://webapi.bps.go.id/v1/api/list/model/publication/lang/ind/domain/1300/page/';
  private apiDetil = 'https://webapi.bps.go.id/v1/api/view/domain/1300/model/publication/lang/ind/id/';
  //private apiSearch = 'https://webapi.bps.go.id/v1/api/list/model/publication/lang/ind/domain/1300/keyword/';
  
  constructor(public http: HttpClient) {
    console.log('Running Publikasi Provider');
  }
